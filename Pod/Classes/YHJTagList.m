...
@interface YHJTagList () <YHJTagViewDelegate>
@property (nonatomic, strong)YHJTagView *temView;
@property (nonatomic, strong)NSMutableArray *tagNames;
@property (nonatomic, strong)NSMutableArray *tagIndexs;
@end

@implementation YHJTagList
...
- (void)display {
    ...
    for (UIView *subview in [self subviews]) {
        if ([subview isKindOfClass:[YHJTagView class]]) {
            YHJTagView *tagView = (YHJTagView*)subview;
...
#pragma mark - YHJTagViewDelegate
